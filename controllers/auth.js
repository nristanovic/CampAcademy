...
exports.register = asyncHandler(async (req, res, next) => {
    ...
    if (password && password.length < 6) {
        req.flash('error', 'Password must be minimum 6 length.');
...
// @route  POST /ap1/v1/auth/forgotpasswrod
// @acces  Public
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    //************* 
    const message = `You are reseiving this email because you has requested the reset of a password. Please meka a PUT request to: \n\n ${resetUrl}`;
